...
class MysqlConnector:
    connection = mysql.connector.connect(user='', password='', host='', database='repairorders')
    cursor = connection.cursor()
    select_all_from_table = "SELECT * FROM repairorders"
    ...
    def create_table(cls):
        try:
            MysqlConnector.cursor.execute("""CREATE TABLE repairorders (
